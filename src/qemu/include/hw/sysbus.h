...
typedef struct SysBusDeviceClass : public DeviceClass {
    #ifdef PEARPC_SHIM
    SysBusDeviceClass(const TypeInfo *type) : DeviceClass(type) {}
    #else
    /*< private >*/
...
struct SysBusDevice : public DeviceState {
    #ifdef PEARPC_SHIM
    SysBusDevice(ObjectClass *cls) : DeviceState(cls) {};
    #else
    /*< private >*/
