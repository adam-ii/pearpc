...
#define trace_xkeymap_vendor(...)
#define trace_xkeymap_extension(...)
#define trace_xkeymap_keycodes(...)
#define trace_xkeymap_keymap(...)

extern const size_t qemu_input_map_xorgevdev_to_qcode_len;
extern const uint16_t qemu_input_map_xorgevdev_to_qcode[];

extern const size_t qemu_input_map_xorgkbd_to_qcode_len;
extern const uint16_t qemu_input_map_xorgkbd_to_qcode[];

extern const size_t qemu_input_map_xorgxquartz_to_qcode_len;
extern const uint16_t qemu_input_map_xorgxquartz_to_qcode[];

extern const size_t qemu_input_map_xorgxwin_to_qcode_len;
extern const uint16_t qemu_input_map_xorgxwin_to_qcode[];
