...
const uint16_t qemu_input_map_xorgkbd_to_qcode[209] = {
...
const size_t qemu_input_map_xorgkbd_to_qcode_len = sizeof(qemu_input_map_xorgkbd_to_qcode)/sizeof(qemu_input_map_xorgkbd_to_qcode[0]);
