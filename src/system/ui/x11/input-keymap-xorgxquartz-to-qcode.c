...
// From QEMU v3.0.0 {build}/ui
const uint16_t qemu_input_map_xorgxquartz_to_qcode[264] = {
...
const size_t qemu_input_map_xorgxquartz_to_qcode_len = sizeof(qemu_input_map_xorgxquartz_to_qcode)/sizeof(qemu_input_map_xorgxquartz_to_qcode[0]);
